...
public class DomainExceptionHandler {
  ...
  private ResponseEntity<ErrorResponse> buildErrorResponse(
      DomainExceptions.HttpException ex,
      HttpStatus status,
      WebRequest request) {
  ...
  public ResponseEntity<ErrorResponse> handleNotFoundException(
      DomainExceptions.NotFoundException ex,
      WebRequest request) {
  ...
  public ResponseEntity<ErrorResponse> handleConflictException(
      DomainExceptions.ConflictException ex,
      WebRequest request) {
  ...
  public ResponseEntity<ErrorResponse> handleValidationException(
      DomainExceptions.ValidationException ex,
      WebRequest request) {
  ...
  public ResponseEntity<ErrorResponse> handleOperationException(
      DomainExceptions.OperationException ex,
      WebRequest request) {
  ...
  public ResponseEntity<ValidationErrorOutput> handleValidationException(
    ...
    Map<String, List<String>> fields = ex.getAllErrors().stream().collect(
        Collectors.groupingBy(
            error -> ((FieldError) error).getField(), Collectors.mapping(
                error -> error.getDefaultMessage(), Collectors.toList())));

    ValidationErrorOutput response = new ValidationErrorOutput(
        "Field has errors", fields);
  ...
  public ResponseEntity<ValidationErrorOutput> handleMissingParamException(
    ...
    Map<String, List<String>> fields = Map
        .of(ex.getParameterName(), List.of("Field is missing"));
    ValidationErrorOutput response = new ValidationErrorOutput(
  ...
  public ResponseEntity<ValidationErrorOutput> handleBadCredentialsException(
      BadCredentialsException ex) {
    return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(
        new ValidationErrorOutput(
            "Credenciales erróneas", Collections.emptyMap()));
  }
}