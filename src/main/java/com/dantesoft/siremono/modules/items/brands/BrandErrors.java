package com.dantesoft.siremono.modules.items.brands;
...
@Slf4j
public class BrandErrors implements DomainExceptions {
  private static final String NOT_FOUND_MESSAGE = "Brand not found with id {}";
  private static final String ALREADY_EXIST_MESSAGE = "Brand with name {} already exists";
  private static final String HAS_ASSOCIACION_MESSAGE = "Cannot delete brand with id: {} because it has associated products";
